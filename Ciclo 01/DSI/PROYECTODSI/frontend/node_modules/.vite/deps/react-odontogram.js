...
//#region node_modules/react-odontogram/dist/index.mjs
var import_react = /* @__PURE__ */ __toESM(require_react(), 1);
var import_jsx_runtime = require_jsx_runtime();
var f1 = ({ conditions: t, className: e = "" }) => !t || t.length === 0 ? null : (0, import_jsx_runtime.jsx)("ul", {
	className: e,
	style: {
		display: "flex",
		gap: 8,
	...
	children: t.map((r) => (0, import_jsx_runtime.jsxs)("li", {
		style: {
			display: "flex",
			alignItems: "center",
			gap: 8
		...
		children: [(0, import_jsx_runtime.jsx)("span", {
			...
			style: {
				...
				border: `2px solid ${r.outlineColor ?? r.fillColor}`,
...
var X = ({ name: t, outlinePath: e, shadowPath: r, lineHighlightPath: c, selected: h, condition: a, readOnly: s, onClick: i, onKeyDown: d, onHover: g, onFocus: x, onLeave: v, onBlur: b, children: p }) => {
	...
	return (0, import_jsx_runtime.jsxs)("g", {
		className: `${t} ${h ? "selected" : ""}`,
		onClick: s ? void 0 : () => i == null ? void 0 : i(t),
		onKeyDown: s ? void 0 : (C) => d == null ? void 0 : d(C, t),
		onMouseEnter: g ? (C) => g(t, C) : void 0,
		onFocus: x ? (C) => x(t, C) : void 0,
		onMouseLeave: v,
		onBlur: b,
		role: s ? void 0 : "option",
		"aria-selected": s ? void 0 : h,
		tabIndex: s ? -1 : 0,
		"aria-label": s ? void 0 : `Tooth ${t.replace("teeth-", "")}`,
		"aria-disabled": s,
		style: {
		...
		children: [
			...
			(0, import_jsx_runtime.jsx)("path", {
				fill: y,
				d: r,
				"data-colored": a ? "true" : void 0,
				style: { opacity: a ? 1 : void 0 }
			}),
			Array.isArray(c) ? c.map((C) => (0, import_jsx_runtime.jsx)("path", {
				stroke: f,
				strokeLinecap: "round",
				strokeLinejoin: "round",
				d: C
			}, C)) : (0, import_jsx_runtime.jsx)("path", {
				stroke: f,
				strokeLinecap: "round",
				strokeLinejoin: "round",
				d: c
...
var Y = 12, k = 8, t1 = (t, e, r) => Math.min(Math.max(t, e), r), x1 = (t) => t.startsWith("bottom"), v1 = (t, e) => {
	if (t) return typeof t == "function" ? t(e) : t;
};
function e1({ active: t, payload: e, position: r, content: c }) {
	let h = (0, import_react.useRef)(null), [a, s] = (0, import_react.useState)(null);
	return (0, import_react.useEffect)(() => {
		...
		m && u > R && (m = !1, u = f), u = t1(u, k, R), s({
			left: p,
			top: u,
			isBottomPlacement: m
		});
	}, [t, r]), t && e ? (0, import_jsx_runtime.jsxs)("div", {
		ref: h,
		...
		children: [v1(c, e) ?? (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
			(0, import_jsx_runtime.jsxs)("div", { children: ["Tooth: ", e.notations.fdi] }),
			(0, import_jsx_runtime.jsxs)("div", { children: ["Type: ", e.type] }),
			(0, import_jsx_runtime.jsxs)("div", { children: [
				"Universal: ",
				e.notations.universal,
				", Palmer:",
				" ",
				e.notations.palmer
			] })
			...
			style: {
				...
				...a != null && a.isBottomPlacement ? {
					top: "-6px",
					borderBottom: "6px solid var(--odontogram-tooltip-bg, rgba(0, 0, 0, 0.85))"
				} : {
					bottom: "-6px",
					borderTop: "6px solid var(--odontogram-tooltip-bg, rgba(0, 0, 0, 0.85))"
				}
			}
		})]
	}) : null;
...
function L1(t, e) {
	...
	return e === "upper" ? "0 0 409 347" : e === "lower" ? "0 347 409 347" : "0 0 409 694";
}
var R1 = ({ defaultSelected: t = [], singleSelect: e = !1, onChange: r, className: c = "", theme: h = "light", colors: a = {}, notation: s = "FDI", tooltip: i = {
	margin: 10,
	placement: "top"
}, showTooltip: d = !0, showHalf: g = "full", name: x, maxTeeth: v = 8, teethConditions: b, readOnly: p = !1, showLabels: f = !1, layout: y = "circle", styles: C }) => {
	let m = y === "circle" ? o1 : r1, u = y === "circle" ? l1 : i1, R = (0, import_react.useMemo)(() => new Map(m.map((o) => [o.name, o.type])), [m]), G = (0, import_react.useCallback)((o) => {
		let l = o.replace("teeth-", "").slice(1);
		return R.get(l) ?? "Unknown";
	}, [R]), $ = (0, import_react.useCallback)((o) => typeof o != "number" || Number.isNaN(o) ? m.length : Math.max(0, Math.min(m.length, Math.floor(o))), [m]), S = (0, import_react.useCallback)((o) => ({
		id: o,
		notations: n1(o),
		type: G(o)
	}), [G]), c1 = h === "dark" ? {
		...
		"--base-blue": "#8a98be",
		"--light-blue": "#c6ccf8"
	}, [O, h1] = (0, import_react.useState)(() => new Set(e ? t.slice(0, 1) : t)), V = (0, import_react.useRef)(null), [F, W] = (0, import_react.useState)({ active: !1 }), B = (0, import_react.useCallback)((o) => {
		p || h1((l) => {
			let n = new Set(l);
			return e ? n.has(o) ? n.delete(o) : (n.clear(), n.add(o)) : n.has(o) ? n.delete(o) : n.add(o), r?.(Array.from(n).map(S)), n;
		});
	}, [
		r,
		p,
		S,
		e
	]), z = (0, import_react.useCallback)((o, l) => {
		p || (o.key === "Enter" || o.key === " ") && (o.preventDefault(), B(l));
	}, [B, p]), H = (0, import_react.useCallback)((o, l, n = "right") => {
		var J, K;
	...
	}, [i.margin, S]), E = (0, import_react.useCallback)(() => {
		W((o) => ({
			...o,
			active: !1
		}));
	}, []), C1 = g === "upper" ? u.slice(0, 2) : g === "lower" ? u.slice(2) : u, j = (0, import_react.useMemo)(() => m.slice(0, $(v)), [
		v,
		$,
		m
		...
		return o;
	}, [b]), m1 = (0, import_react.useCallback)((o) => j.map((l) => {
		...
		return (0, import_jsx_runtime.jsx)(X, {
			...
			onClick: B,
			onKeyDown: z,
			onHover: d ? (w, Z) => H(w, Z, i.placement) : void 0,
			onFocus: d ? (w, Z) => H(w, Z, i.placement) : void 0,
			onLeave: d ? E : void 0,
			onBlur: d ? E : void 0,
			children: (0, import_jsx_runtime.jsx)("title", { children: L })
		}, n);
	}), [
		j,
		s,
	...
	return (0, import_jsx_runtime.jsxs)("div", {
		...
		role: p ? "group" : "listbox",
		"aria-multiselectable": p ? void 0 : !e,
		...
		children: [
			(0, import_jsx_runtime.jsx)("input", {
				type: "hidden",
				name: x ?? "teeth",
				value: JSON.stringify(Array.from(O))
			}),
			(0, import_jsx_runtime.jsxs)("svg", {
				...
				children: [(0, import_jsx_runtime.jsx)("title", { children: "Odontogram" }), C1.map(({ name: o, transform: l, label: n }, L) => (0, import_jsx_runtime.jsx)("g", {
					transform: l,
					children: m1(`teeth-${L + 1}`)
				}, o))]
			}),
			d && (0, import_jsx_runtime.jsx)(e1, {
				active: F.active,
				position: F.position,
				payload: F.payload,
				content: i.content
			}),
			f && (0, import_jsx_runtime.jsx)(Q, { conditions: b })
		]
	});
}, Z1 = R1;
//#endregion
export { R1 as Odontogram, Z1 as default, L1 as getViewBox };

//# sourceMappingURL=react-odontogram.js.map